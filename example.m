...
% function and replace <edge name> by edge(<i>,k)
...
% for a shorter computation time, comment the first four lines of this
% function and replace <node name> by node(<i>,k)
...
% if not automatically plots all the nodes (plot_all=0) then plot your own, such
% as EGF, EGFR, PI3K and ERK
if not(plot_all)
    figure(1)
    clf(1)
    for i_r=1:r
...
% [1] Melody K Morris, Julio Saez-Rodriguez, Peter K Sorger, Douglas A
% Lauffenburger (2010) Logic-based models for the analysis of cell signaling
% networks. Biochemistry 49(15):3216-3224.
